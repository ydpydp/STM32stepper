...
/* #define USE_FULL_ASSERT    1 */
 ...
 #define  MOTOR_COTR_PULSE    GPIO_Pin_6
 #define  MOTOR_COTR_DIR    GPIO_Pin_7
 #define  MOTOR_COTR_DIS    GPIO_Pin_8
 #define  MOTOR_LMTPOS    GPIO_Pin_0  //S2 PC0
 #define  MOTOR_LMTNEG    GPIO_Pin_1  //S3 PC1

#define CONTROL_PORT  GPIOA
#define MACHINPUT_PORT  GPIOC
